            ...
            try:
                ...
                for term in SEED_TERMS:
                    ...
                    if z >= Z_THRESHOLD and pct > 50:
                        # Fetch related queries — the actual phrases people searched
                        related = []
                        try:
                            time.sleep(3)  # small pause before related query request
                            ...
                            print(f"    Could not fetch related queries: {re}")
                ...
                # Small pause between timeframe requests
                time.sleep(5)
